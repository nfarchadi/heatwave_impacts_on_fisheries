...
saveRDS(CAR_OISST_data, here("data","water_temp","NWA","oisst",
                             "CAR_OISST.rds"))
...
saveRDS(FEC_OISST_data, here("data","water_temp","NWA","oisst",
                             "FEC_OISST.rds"))
...
saveRDS(GOM_OISST_data, here("data","water_temp","NWA","oisst",
                             "GOM_OISST.rds"))
...
saveRDS(MAB_OISST_data, here("data","water_temp","NWA","oisst",
                             "MAB_OISST.rds"))
...
saveRDS(NCA_OISST_data, here("data","water_temp","NWA","oisst",
                             "NCA_OISST.rds"))
...
saveRDS(NEC_OISST_data, here("data","water_temp","NWA","oisst",
                             "NEC_OISST.rds"))
...
saveRDS(NED_OISST_data, here("data","water_temp","NWA","oisst",
                             "NED_OISST.rds"))
...
saveRDS(SAB_OISST_data, here("data","water_temp","NWA","oisst",
                             "SAB_OISST.rds"))
...
saveRDS(SAR_OISST_data, here("data","water_temp","NWA","oisst",
                             "SAR_OISST.rds"))

...
#this code largely follows https://robwschlegel.github.io/heatwaveR/articles/OISST_preparation.html
...
saveRDS(CAR_OISST_data, here("data","env_data","NWA","oisst","CAR_OISST.rds"))
...
saveRDS(FEC_OISST_data, here("data","env_data","NWA","oisst","FEC_OISST.rds"))
...
saveRDS(GOM_OISST_data, here("data","env_data","NWA","oisst","GOM_OISST.rds"))
...
saveRDS(MAB_OISST_data, here("data","env_data","NWA","oisst","MAB_OISST.rds"))

rm(MAB_OISST_data, MAB, MABcrop_x, MABcrop_y)

####----NCA----####
NCA<-NWA_PLL_zones %>% filter(ET_ID == "NCA") %>% st_bbox()
NCAcrop_x <- st_bbox(NCA)[c(1,3)]
NCAcrop_y <- st_bbox(NCA)[c(2,4)]
...
saveRDS(NCA_OISST_data, here("data","env_data","NWA","oisst","NCA_OISST.rds"))

rm(NCA_OISST_data, NCA, NCAcrop_x, NCAcrop_y)
...
saveRDS(NEC_OISST_data, here("data","env_data","NWA","oisst", "NEC_OISST.rds"))
...
saveRDS(NED_OISST_data, here("data","env_data","NWA","oisst","NED_OISST.rds"))
...
saveRDS(SAB_OISST_data, here("data","env_data","NWA","oisst","SAB_OISST.rds"))
...
saveRDS(SAR_OISST_data, here("data","env_data","NWA","oisst","SAR_OISST.rds"))

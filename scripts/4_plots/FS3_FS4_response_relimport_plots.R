# Fig. S3. The relative importance of drivers in vessel distribution models
# Fig. S4. Response curves of each environmental variable from vessel distribution models
...
#NWA PLL
brt_PLL <- here("data","VDM_and_val","NWA_PLL","brt_VDM_eval_gbm_step.rds") %>% readRDS()
...
ggsave(here("Plots","FS4_response_plots.png"),
       width = 7, height = 6, units = "in", dpi = 300)
ggsave(here("Plots","FS4_response_plots.svg"),
       width = 7, height = 6, units = "in", dpi = 300)

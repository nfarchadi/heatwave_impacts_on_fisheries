...
CAR<-NWA_PLL_areas %>% filter(ET_ID == "CAR") %>% st_bbox()
...
FEC<-NWA_PLL_areas %>% filter(ET_ID == "FEC") %>% st_bbox()
...
GOM<-NWA_PLL_areas %>% filter(ET_ID == "GOM") %>% st_bbox()
...
MAB<-NWA_PLL_areas %>% filter(ET_ID == "MAB") %>% st_bbox()
...
NEC<-NWA_PLL_areas %>% filter(ET_ID == "NEC") %>% st_bbox()
...
NED<-NWA_PLL_areas %>% filter(ET_ID == "NED") %>% st_bbox()
...
SAB<-NWA_PLL_areas %>% filter(ET_ID == "SAB") %>% st_bbox()
...
SAR<-NWA_PLL_areas %>% filter(ET_ID == "SAR") %>% st_bbox()
